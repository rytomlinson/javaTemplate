 ...
 */
@Entity
@Table(name = "survey_request_text_answer", schema = "insight", catalog = "test_navis")
public class SurveyRequestTextAnswerEntity {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        SurveyRequestTextAnswerEntity that = (SurveyRequestTextAnswerEntity) o;
